...
$(document).ready(function () {
    var table = $('#entityfee').DataTable({
        ...
        columns: [
            ...
            {
                "title": "Actions",
                "data": { "id": "id", "name": "name", "entityId":"entityId" },
                "class": "text-center",
                "width": "20%",
                "searchable": false,
                "sortable": false,
                "render": function (data, type, full, meta) {
                    return '<a href="/EntityFee/AddEntityFee?entityId=' + data.entityId + '"><i class="fas fa-pencil-alt"></i></a>&nbsp;&nbsp;&nbsp;<a href="/Entity/_Deactivateentity?id=' + data + '" class="deactivateentity" title="Deactivate"><i class="fas fa-trash-alt" style="color:#dc3545"></i></a>  <a class="view-aspects" href="/Entity/_ViewEntityAspects?id=' + data.id + '&name=' + data.name + '"><button class="btn btn-success btn-xs"><i class="glyphicon glyphicon-list-alt"></i> View Aspects</button> </a>';
                }
            }
        ],
        "language": {
