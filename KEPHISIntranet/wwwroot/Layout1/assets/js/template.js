...
(function($) {
  ...
  $(function() {
    ...
    //    <a href="#" target="_blank" class="btn btn-primary text-white fw-bolder btn-icon-text">\
    //      <i data-feather="file-text"></i>\
    //    </a>\
    //    <a href="# target="_blank" class="btn btn-danger text-white fw-bolder btn-icon-text">\
