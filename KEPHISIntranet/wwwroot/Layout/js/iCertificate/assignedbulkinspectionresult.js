...
$(document).ready(function () {
    ...
    var table = $('#assignmentResult').DataTable({
        "serverSide": true,
        "proccessing": true,
        "ajax": {
            "url": "/BulkInspectionResult/GetBulkInspectionResult",
            "type": "POST",
        ...
        columns: [
            ...
            },
            {
                ...
                "render": function (data, type, full, meta) {
                    return '<a class="view-employee" href="/AssignedInspectionResult/InspectionResultDetails?id=' + data.id + '"><i class="fas fa-edit"></i></a>  <a target="_blank" href="/AssignedInspectionResult/ConfirmPrintCertificate?id=' + data.id + '" class="printCert" data-toggle="tooltip" title="Print Cert"><i class="mdi mdi-printer" style="color:#595959;font-size:17px"></i></a>  <a href="/IssuedCertificates/ConfirmRejectCertificate?id=' + data.id + '" class="rejectCert" title="Reject Cert"><i class="fas fa-trash-alt" style="color:#dc3545"></i></a>';
                }
            }
        ]
    });
    ...
    $('#assignmentResult').on("click", ".printCert", function (event) {
